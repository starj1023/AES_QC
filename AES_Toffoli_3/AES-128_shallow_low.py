...
def AES(eng, resource_check):
    ...
    for p in range(5):
        ...
        if (i != 0):
            ...
            Clean_ancilla(eng, t0, t1, t2, t3, temp_k, y_two, t_two, z_two, w_two, l_two, resource_check)
        ...
        if (i != 9):
            Clean_ancilla(eng, t0, t1, t2, t3, temp_k, y, t, z, w, l, resource_check)
        Keyshedule(eng, k, i, y_two, t_two, z_two, w_two, l_two, i, resource_check)
        ...
        SBox_bp12_all(eng, x0, x1, x2, x3, y_two, t_two, z_two, w_two, l_two, s1, i, resource_check)
        x0, x1, x2, x3 = Shiftrow(eng, x0, x1, x2, x3)
