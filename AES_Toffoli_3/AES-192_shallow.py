...
def AES(eng, resource_check):
    ...
    for p in range(4):
        ...
        if(i != -1):
            if (i % 2 == 0):
                Clean_ancilla(eng, t0, t1, t2, t3, temp_k, y, t, z, w, l, 1, resource_check)
            else:
                Clean_ancilla(eng, t0, t1, t2, t3, temp_k, y_two, t_two, z_two, w_two, l_two, 1, resource_check)
        ...
        if(i%2 == 0):
            ...
            SBox_bp12_all(eng, x0, x1, x2, x3, y_two, t_two, z_two, w_two, l_two, s, i, resource_check)
        ...
        if (i % 2 == 0):
            ...
            Keyshedule(eng, k, i, y_two, t_two, z_two, w_two, l_two, i, k_i, resource_check)
        ...
        if (i % 2 == 0):
            Clean_ancilla(eng, t0, t1, t2, t3, temp_k, y, t, z, w, l, 0, resource_check)

        else:
            Clean_ancilla(eng, t0, t1, t2, t3, temp_k, y_two, t_two, z_two, w_two, l_two, 0, resource_check)
