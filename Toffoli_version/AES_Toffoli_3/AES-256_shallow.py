...
def AES(eng, resource_check):
    ...
    for i in range(14):
        ...
        if(i!= 0 and i!= 1 and i!= 13 and i % 2 == 0):
            Clean_ancilla(eng, t0, t1, t2, t3, k[0:32], y_two, t_two, z_two, w_two, l_two, 0, k_i, resource_check)
        ...
        if(i!=0):
            if(i%2 == 0):
                ...
                Keyshedule(eng, k, i, y_two, t_two, z_two, w_two, l_two, i, k_i, resource_check) #i=1, k_i=0, _two, i=3, k_i=2, _two
