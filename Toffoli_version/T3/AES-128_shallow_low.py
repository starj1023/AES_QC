...
def AES(eng, resource_check):
    ...
    mq1 = eng.allocate_qureg(420) # Excluded for qubit count
    ...
    for p in range(5):
        ...
        if(i != 0):
            ...
            Clean_ancilla_two(eng, t0, t1, t2, t3, k[32:64], y_two, t_two, z_two, z, w_two, w, l_two, resource_check)
        ...
        CNOT32(eng, k[0:32], k[32:64])
        if(i!= 9):
            Clean_ancilla(eng, t0, t1, t2, t3, k[32:64], y, t, z, w, l, resource_check)
        else:
            Clean_ancilla_special(eng, t0, t1, t2, t3, k[32:64], y, t, z, w, l, resource_check)

        Keyshedule_two(eng, k, i, y_two, t_two, z_two, z, w_two, w, l_two, i, resource_check)
        CNOT32(eng, k[0:32], k[32:64])
        ...
        SBox_bp12_all_two(eng, x0, x1, x2, x3, y_two, t_two, z_two, z, w_two, w, l_two, s1, i, resource_check)
        x0, x1, x2, x3 = Shiftrow(eng, x0, x1, x2, x3)
...
def Clean_ancilla(eng, x0, x1, x2, x3, temp_k, y, t, z, w, l, resource_check):
...
def Clean_ancilla_special(eng, x0, x1, x2, x3, temp_k, y, t, z, w, l, resource_check):
...
def Clean_ancilla_two(eng, x0, x1, x2, x3, temp_k, y, t, z, z_two, w, w_two, l, resource_check):
...
def Keyshedule_two(eng, k, i, y, t, z, z_two, w, w_two, l, round, resource_check):
...
def SBox_bp12_all_two(eng, x0, x1, x2, x3, y, t, z, z_two, w, w_two, l, s, round, resource_check):
    ...
    for i in range(4):
        x0[8 * i:8 * (i + 1)] = Sbox_two(eng, x0[8 * i:8 * (i + 1)], y[27 * i:27 * (i + 1)], t[50 * i:50 * (i + 1)],
                                          z[41 * i:41 * (i + 1)], z_two[41 * i:41 * (i + 1)], w[34 * i:34 * (i + 1)], w_two[34 * i:34 * (i + 1)], l[30 * i:30 * (i + 1)], s[8 * i:8 * (i + 1)], 0, round, resource_check)

        x1[8 * i:8 * (i + 1)] = Sbox_two(eng, x1[8 * i:8 * (i + 1)], y[27 * (i + 4):27 * (i + 5)],
                                          t[50 * (i + 4):50 * (i + 5)], z[41 * (i + 4):41 * (i + 5)], z_two[41 * (i + 4):41 * (i + 5)],
                                          w[34 * (i+4):34 * (i + 5)], w_two[34 * (i+4):34 * (i + 5)], l[30 * (i+4):30 * (i + 5)], s[8 * (i + 4):8 * (i + 5)], 0, round, resource_check)
        ...
        x3[8 * i:8 * (i + 1)] = Sbox_two(eng, x3[8 * i:8 * (i + 1)], y[27 * (i + 12):27 * (i + 13)],
                                          t[50 * (i + 12):50 * (i + 13)], z[41 * (i + 12):41 * (i + 13)], z_two[41 * (i + 12):41 * (i + 13)],
                                          w[34 * (i+12):34 * (i + 13)], w_two[34 * (i+12):34 * (i + 13)], l[30 * (i+12):30 * (i + 13)], s[8 * (i + 12):8 * (i + 13)], 0, round, resource_check)
