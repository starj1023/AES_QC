...
def AES(eng, resource_check):
    ...
    for p in range(5):
        ...
        if (i != 0):
            ...
            Clean_ancilla_two(eng, t0, t1, t2, t3, k[32:64], q_two, q, resource_check)
        ...
        CNOT32(eng, k[0:32], k[32:64])
        if (i != 9):
            Clean_ancilla(eng, t0, t1, t2, t3, k[32:64], q, resource_check)
        else:
            Clean_ancilla_special(eng, t0, t1, t2, t3, k[32:64], q, resource_check)

        Keyshedule_two(eng, k, i, q_two, q, i, resource_check)
        CNOT32(eng, k[0:32], k[32:64])
        ...
        if (i != 9):
            ...
            s1 = recycle(eng, q) # key: 0~8, 34~45, Sbox: 6~8
        ...
        SBox_bp12_all_two(eng, x0, x1, x2, x3, q_two, q, s1, i, resource_check)
...
def Clean_ancilla(eng, x0, x1, x2, x3, temp_k, q, resource_check):
...
def Clean_ancilla_two(eng, x0, x1, x2, x3, temp_k, q2, q1, resource_check):

    for i in range(4):
        Uncompute_sbox_two(eng, x0[8 * i:8 * (i + 1)], q2[25 * i:25 * (i + 1)], q1[73 * i:73 * (i + 1)], resource_check)
        Uncompute_sbox_two(eng, x1[8 * i:8 * (i + 1)], q2[25 * (i + 4):25 * (i + 5)], q1[73 * (i+4):73 * (i + 5)], resource_check)
        Uncompute_sbox_two(eng, x2[8 * i:8 * (i + 1)], q2[25 * (i + 8):25 * (i + 9)], q1[73 * (i+8):73 * (i + 9)], resource_check)
        Uncompute_sbox_two(eng, x3[8 * i:8 * (i + 1)], q2[25 * (i + 12):25 * (i + 13)], q1[73 * (i+12):73 * (i + 13)], resource_check)
...
def Keyshedule_two(eng, k, i, q2, q1, round, resource_check):
    Rcon = [0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36]
