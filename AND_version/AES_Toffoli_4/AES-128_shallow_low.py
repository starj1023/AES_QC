...
def AES(eng, resource_check):
    ...
    for p in range(5):
        ...
        Keyshedule(eng, k, i, y, t, z, i, ancilla, resource_check)
        ...
        Keyshedule(eng, k, i, y_two, t_two, z_two, i, ancilla, resource_check)
...
def Keyshedule(eng, k, i, y, t, z, round, ancilla, resource_check):
