...
def AES(eng, resource_check):
    ...
    for p in range(4):
        ...
        if(i != -1):
            if (i % 2 == 0):
                Clean_ancilla(eng, t0, t1, t2, t3, temp_k, y, t, z, w, l, 1, ancilla, resource_check)
            else:
                Clean_ancilla(eng, t0, t1, t2, t3, temp_k, y_two, t_two, z_two, w_two, l_two, 1, ancilla, resource_check)
        ...
        if(i%2 == 0):
            ...
            SBox_bp12_all(eng, x0, x1, x2, x3, y_two, t_two, z_two, w_two, l_two, s, i, ancilla, resource_check)
            x0, x1, x2, x3 = Shiftrow(eng, x0, x1, x2, x3)
        ...
        if (i % 2 == 0):
            ...
            Keyshedule(eng, k, i, y_two, t_two, z_two, w_two, l_two, i, k_i, ancilla, resource_check)
        ...
        if (i % 2 == 0):
            Clean_ancilla(eng, t0, t1, t2, t3, temp_k, y, t, z, w, l, 0, ancilla, resource_check)

        else:
            Clean_ancilla(eng, t0, t1, t2, t3, temp_k, y_two, t_two, z_two, w_two, l_two, 0, ancilla, resource_check)
...
def Clean_ancilla(eng, x0, x1, x2, x3, temp_k, y, t, z, w, l, flag, ancilla, resource_check):
...
def Keyshedule(eng, k, i, y, t, z, w, l, round, k_i, ancilla, resource_check):
    ...
    for j in range(4): #22 68 18
         k[160 + 8 * j: 160 + 8 * (j + 1)] = AND_KS_Sbox_T3(eng, new_k0[8 * j:8 * (j + 1)], y[432 + 27 * j:432 + 27 * (j + 1)],
