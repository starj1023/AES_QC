...
def AES(eng, resource_check):
    ...
    ancilla = eng.allocate_qureg(432)  # 20 * 20 + 8 * 4
    ...
    for i in range(14):
        ...
        if(i!=0):
            Keyshedule(eng, k, i, y, t, z, w, l, i, k_i, ancilla, resource_check)
            k_i = k_i + 1
...
def Keyshedule(eng, k, i, y, t, z, w, l, round, k_i, ancilla, resource_check):
    ...
    if (k_i % 2 == 0):
        for j in range(4): #22 68 18
             k[224 + 8 * j: 224 + 8 * (j + 1)] = AND_KS_Sbox_T3(eng, new_k0[8 * j:8 * (j + 1)], y[432 + 27 * j:432 + 27 * (j + 1)],
...
def SBox_bp12_all(eng, x0, x1, x2, x3, y, t, z, w, l, s, round, ancilla, resource_check):
    for i in range(4):
        x0[8 * i:8 * (i + 1)] = AND_Sbox_T3(eng, x0[8 * i:8 * (i + 1)], y[27 * i:27 * (i + 1)], t[50 * i:50 * (i + 1)],
                                          z[41 * i:41 * (i + 1)], w[34 * i:34 * (i + 1)], l[30 * i:30 * (i + 1)], s[8 * i:8 * (i + 1)], 0, round, ancilla[20 * i:20 * (i + 1)], resource_check)

        x1[8 * i:8 * (i + 1)] = AND_Sbox_T3(eng, x1[8 * i:8 * (i + 1)], y[27 * (i + 4):27 * (i + 5)],
                                          t[50 * (i + 4):50 * (i + 5)], z[41 * (i + 4):41 * (i + 5)],
                                          w[34 * (i+4):34 * (i + 5)], l[30 * (i+4):30 * (i + 5)], s[8 * (i + 4):8 * (i + 5)], 0, round, ancilla[20 * (i + 4):20 * (i + 5)], resource_check)
        x2[8 * i:8 * (i + 1)] = AND_Sbox_T3(eng, x2[8 * i:8 * (i + 1)], y[27 * (i + 8):27 * (i + 9)],
                                          t[50 * (i + 8):50 * (i + 9)], z[41 * (i + 8):41 * (i + 9)], w[34 * (i+8):34 * (i + 9)], l[30 * (i+8):30 * (i + 9)],
                                          s[8 * (i + 8):8 * (i + 9)], 0, round, ancilla[20 * (i + 8):20 * (i + 9)], resource_check)

        x3[8 * i:8 * (i + 1)] = AND_Sbox_T3(eng, x3[8 * i:8 * (i + 1)], y[27 * (i + 12):27 * (i + 13)],
                                          t[50 * (i + 12):50 * (i + 13)], z[41 * (i + 12):41 * (i + 13)],
                                          w[34 * (i+12):34 * (i + 13)], l[30 * (i+12):30 * (i + 13)], s[8 * (i + 12):8 * (i + 13)], 0, round, ancilla[20 * (i + 12):20 * (i + 13)], resource_check)
...
def AND_KS_Sbox_T3(eng, u_in, t, m, n, w, l, s, flag, round, and_ancilla, resource_check):
    u = []
    for i in range(8):
        u.append(u_in[7 - i])
    ...
    AND_gate(eng, m[27 - 1], t[16 - 1], n[10 - 1], and_ancilla[18])  # 2

    AND_gate(eng, l[12 - 1], t[9 - 1], n[11 - 1], and_ancilla[19])  # 2

    AND_gate(eng, m[46 - 1], t[17 - 1], n[13 - 1], and_ancilla[20])  # 2
    AND_gate(eng, l[13 - 1], m[41 - 1], n[14 - 1], and_ancilla[21])  # 2

    # ** ** ** ** ** ** ** ** ** ** ** ** ** **

    AND_gate(eng, l[14 - 1], t[15 - 1], n[16 - 1], and_ancilla[22])  # 2
    AND_gate(eng, l[3 - 1], m[39 - 1], n[17 - 1], and_ancilla[23])  # 2
    AND_gate(eng, n[15 - 1], m[40 - 1], w[9 - 1], and_ancilla[24])  # 2

    CNOT2(eng, m[30 - 1], m[32 - 1], n[18 - 1])
    CNOT2(eng, n[15 - 1], n[18 - 1], n[19 - 1])
    CNOT2(eng, m[28 - 1], m[29 - 1], n[20 - 1])
    CNOT2(eng, m[26 - 1], m[31 - 1], n[21 - 1])
    AND_gate(eng, l[15 - 1], t[27 - 1], n[22 - 1], and_ancilla[25])  # 2
    ...
    AND_gate(eng, m[29 - 1], n[11 - 1], w[7 - 1], and_ancilla[20])  # 3
    CNOT2(eng, w[7 - 1], n[12 - 1], m[37 - 1])

    AND_gate(eng, m[28 - 1], n[14 - 1], w[8 - 1], and_ancilla[21])  # 3
    CNOT2(eng, w[8 - 1], n[13 - 1], m[38 - 1])

    AND_gate(eng, n[16 - 1], l[4 - 1], w[10 - 1], and_ancilla[22])  # 3
    AND_gate(eng, n[17 - 1], l[1 - 1], w[11 - 1], and_ancilla[23])  # 3
    CNOT2(eng, w[9 - 1], w[10 - 1], m[39 - 1])
    CNOT | (w[11 - 1], m[39 - 1])

    AND_gate(eng, n[19 - 1], t[27 - 1], w[12 - 1], and_ancilla[24])  # 3
    AND_gate(eng, n[20 - 1], n[22 - 1], w[13 - 1], and_ancilla[25])  # 3
    AND_gate(eng, n[21 - 1], n[23 - 1], w[14 - 1], and_ancilla[26])  # 3
    CNOT2(eng, w[12 - 1], w[13 - 1], m[40 - 1])
    CNOT | (w[14 - 1], m[40 - 1])

    AND_gate(eng, l[7 - 1], n[24 - 1], w[15 - 1], and_ancilla[27])  # 3
    ...
    if (round != 13):
        with Dagger(eng):
            ...
            CNOT2(eng, m[21 - 1], m[30 - 1], n[8 - 1])
            CNOT2(eng, m[28 - 1], m[29 - 1], n[9 - 1])
            AND_gate_dag(eng, m[27 - 1], t[16 - 1], n[10 - 1], and_ancilla[18])  # 2

            AND_gate_dag(eng, l[12 - 1], t[9 - 1], n[11 - 1], and_ancilla[19])  # 2

            AND_gate_dag(eng, m[46 - 1], t[17 - 1], n[13 - 1], and_ancilla[20])  # 2
            AND_gate_dag(eng, l[13 - 1], m[41 - 1], n[14 - 1], and_ancilla[21])  # 2

            # ** ** ** ** ** ** ** ** ** ** ** ** ** **

            AND_gate_dag(eng, l[14 - 1], t[15 - 1], n[16 - 1], and_ancilla[22])  # 2
            AND_gate_dag(eng, l[3 - 1], m[39 - 1], n[17 - 1], and_ancilla[23])  # 2
            AND_gate_dag(eng, n[15 - 1], m[40 - 1], w[9 - 1], and_ancilla[24])  # 2

            CNOT2(eng, m[30 - 1], m[32 - 1], n[18 - 1])
            CNOT2(eng, n[15 - 1], n[18 - 1], n[19 - 1])
            CNOT2(eng, m[28 - 1], m[29 - 1], n[20 - 1])
            CNOT2(eng, m[26 - 1], m[31 - 1], n[21 - 1])
            AND_gate_dag(eng, l[15 - 1], t[27 - 1], n[22 - 1], and_ancilla[25])  # 2
            ...
            AND_gate_dag(eng, m[29 - 1], n[11 - 1], w[7 - 1], and_ancilla[20])  # 3
            CNOT2(eng, w[7 - 1], n[12 - 1], m[37 - 1])

            AND_gate_dag(eng, m[28 - 1], n[14 - 1], w[8 - 1], and_ancilla[21])  # 3
            CNOT2(eng, w[8 - 1], n[13 - 1], m[38 - 1])

            AND_gate_dag(eng, n[16 - 1], l[4 - 1], w[10 - 1], and_ancilla[22])  # 3
            AND_gate_dag(eng, n[17 - 1], l[1 - 1], w[11 - 1], and_ancilla[23])  # 3
            CNOT2(eng, w[9 - 1], w[10 - 1], m[39 - 1])
            CNOT | (w[11 - 1], m[39 - 1])

            AND_gate_dag(eng, n[19 - 1], t[27 - 1], w[12 - 1], and_ancilla[24])  # 3
            AND_gate_dag(eng, n[20 - 1], n[22 - 1], w[13 - 1], and_ancilla[25])  # 3
            AND_gate_dag(eng, n[21 - 1], n[23 - 1], w[14 - 1], and_ancilla[26])  # 3
            CNOT2(eng, w[12 - 1], w[13 - 1], m[40 - 1])
            CNOT | (w[14 - 1], m[40 - 1])

            AND_gate_dag(eng, l[7 - 1], n[24 - 1], w[15 - 1], and_ancilla[27])  # 3
...
def AND_Sbox_T3(eng, u_in, t, m, n, w, l, s, flag, round, and_ancilla, resource_check):
    u = []
    for i in range(8):
        u.append(u_in[7 - i])
