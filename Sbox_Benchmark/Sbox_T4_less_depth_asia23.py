...
def Sbox_asia23(eng, u, q, s):
    ...
    Toffoli_gate(eng, q[29], q[28], q[30])
    Toffoli_gate(eng, q[27], q[25], q[31])
    ...
    Toffoli_gate(eng, q[36], q[5], q[43])
    ...
    Toffoli_gate(eng, q[72], q[1], q[59])
    CNOT | (q[15], q[60])
    CNOT | (q[9], q[61])
    CNOT | (q[28], q[62])
    CNOT | (q[25], q[63])
