...
def Sbox_test(eng):
    ...
    if(resource_check != 1):
        Round_constant_XOR(eng, u_in, 0xee, 8)
        print('Input')
...
def Sbox(eng, u, q, s):
    CNOT2(eng, u[7], u[4], q[34])
    CNOT2(eng, u[7], u[2], q[35])
    CNOT | (u[1], u[7])
    CNOT2(eng, u[4], u[2], q[36])
    CNOT | (u[1], u[3])
    CNOT2(eng, q[34], u[3], q[37])
    CNOT2(eng, u[6], u[5], q[38])
    CNOT2(eng, u[0], q[37], q[39])
    CNOT2(eng, u[0], q[38], q[40])
    CNOT2(eng, q[37], q[38], q[41])
    CNOT | (u[2], u[6])
    CNOT | (u[2], u[5])
    CNOT2(eng, u[7], q[36], q[42])
    CNOT2(eng, q[37], u[6], q[59])
    CNOT | (u[3], u[6])
    CNOT | (u[5], u[3])
    CNOT2(eng, q[40], u[3], q[43])
    CNOT | (u[0], u[4])
    CNOT | (q[38], u[4])
    CNOT2(eng, q[34], u[4], q[44])
    CNOT | (u[0], u[1])
    CNOT | (u[1], q[38])
    CNOT2(eng, q[35], q[38], q[45])
    CNOT | (q[34], u[5])
    ...
    CNOT2(eng, q[35], q[41], q[51])
    CNOT2(eng, q[44], q[43], q[52])
    CNOT2(eng, u[7], u[3], q[53])
    CNOT | (q[59], q[1])
    CNOT | (q[34], u[5])
    CNOT | (u[5], u[3])
    CNOT | (u[3], u[6])
    ...
    CNOT | (q[53], q[51])
    CNOT2(eng, q[53], q[5], q[54])
    CNOT | (q[7], q[53])
    CNOT | (q[4], q[53])
    CNOT | (q[3], q[53])
    CNOT2(eng, u[7], u[3], q[53])
    CNOT | (q[1], q[52])
    CNOT2(eng, q[0], q[9], q[55])
    CNOT2(eng, q[1], q[0], q[56])
    CNOT2(eng, q[5], q[9], q[57])
    CNOT | (q[54], q[52])
    CNOT | (q[56], q[51])
    ...
    CNOT | (q[50], q[58])
    CNOT | (q[46], q[59])
    CNOT2(eng, q[31], q[32], q[51])
    CNOT2(eng, q[20], q[26], q[52])
    ...
    CNOT | (q[17], q[16])
    CNOT | (q[21], q[29])
    CNOT2(eng, q[22], q[23], q[54])
    CNOT | (q[24], q[23])
    CNOT | (q[53], q[30])
    CNOT | (q[18], q[21])
    CNOT2(eng, q[19], q[23], q[55])
    CNOT | (q[51], q[20])
    CNOT | (q[31], q[22])
    CNOT | (q[52], q[25])
    CNOT | (q[51], q[26])
    ...
    CNOT | (q[30], q[22])
    CNOT | (q[30], q[27])
    CNOT2(eng, q[25], q[19], s[7])
    CNOT2(eng, q[26], q[54], s[6])
    CNOT2(eng, q[33], q[22], s[5])
    CNOT2(eng, q[52], q[19], s[4])
    CNOT2(eng, q[51], q[21], s[3])
    CNOT2(eng, q[55], q[27], s[2])
    CNOT2(eng, q[20], q[23], s[1])
    CNOT2(eng, q[19], q[53], s[0])
    X | s[6]
    X | s[5]
    X | s[1]
    X | s[0]
