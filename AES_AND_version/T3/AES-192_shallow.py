...
def AES(eng, resource_check):
    ...
    for p in range(4):
        ...
        if (i != -1):
            if (i % 2 == 0):
                Clean_ancilla(eng, t0, t1, t2, t3, k[32:64], y, t, z, w, l, 1, ancilla)
            else:
                Clean_ancilla_two(eng, t0, t1, t2, t3, k[32:64], y_two, t_two, z_two, z, w_two, w, l_two, 1, ancilla)
        i = i + 1
        ...
        if (i % 2 == 0):
            Keyshedule(eng, k, i, y, t, z, w, l, i, k_i, ancilla)
        else:
            Keyshedule_two(eng, k, i, y_two, t_two, z_two, z, w_two, w, l_two, i, k_i, ancilla)
        ...
        if (i % 2 == 0):
            Clean_ancilla(eng, t0, t1, t2, t3, k[32:64], y, t, z, w, l, 0, ancilla)

        else:
            Clean_ancilla_two(eng, t0, t1, t2, t3, k[32:64], y_two, t_two, z_two, z, w_two, w, l_two, 0, ancilla)
        ...
        if (i != 10):
            if (i % 2 == 0):
                ...
                Clean_ancilla_two(eng, t0, t1, t2, t3, k[32:64], y_two, t_two, z_two, z, w_two, w, l_two, 0,
                                  ancilla)
        else:
            Clean_ancilla_special(eng, t0, t1, t2, t3, k[32:64], y, t, z, w, l, 0, ancilla)
...
def Clean_ancilla_omit_key(eng, x0, x1, x2, x3, temp_k, y, t, z, w, l, flag, ancilla):
    for i in range(4):
...
def Clean_ancilla_omit_key_two(eng, x0, x1, x2, x3, temp_k, y, t, z, z_two, w, w_two, l, flag, ancilla):
    for i in range(4):
...
def Clean_ancilla(eng, x0, x1, x2, x3, temp_k, y, t, z, w, l, flag, ancilla):
...
def Clean_ancilla_two(eng, x0, x1, x2, x3, temp_k, y, t, z, z_two, w, w_two, l, flag, ancilla):
...
def Clean_ancilla_special(eng, x0, x1, x2, x3, temp_k, y, t, z, w, l, flag, ancilla):
