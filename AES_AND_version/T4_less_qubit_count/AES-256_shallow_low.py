...
def AES(eng, resource_check):
    ...
    ancilla = eng.allocate_qureg(232)
...
def Keyshedule(eng, k, i, q, round, k_i, ancilla):
    ...
    if (k_i % 2 == 0):
        for j in range(4): #22 68 18
             k[224 + 8 * j: 224 + 8 * (j + 1)] = Sbox(eng, new_k0[8 * j:8 * (j + 1)], q[1168 + 73 * j:1168 + 73 * (j + 1)], k[224 + 8 * j: 224 + 8 * (j + 1)], 1, round, ancilla[160 + 18 * j: 160 + 18 * (j+1)])
    else:
        for j in range(4): #22 68 18
             k[96 + 8 * j: 96 + 8 * (j + 1)] = Sbox(eng, new_k0[8 * j:8 * (j + 1)], q[1168 + 73 * j:1168 + 73 * (j + 1)], k[96 + 8 * j: 96 + 8 * (j + 1)], 1, round, ancilla[160 + 18 * j: 160 + 18 * (j+1)])
    ...
    if (k_i % 2 == 0):
        for j in range(4):  # 22 68 18
            k[224 + 8 * j: 224 + 8 * (j + 1)] = Sbox_two(eng, new_k0[8 * j:8 * (j + 1)], q2[960 + 60 * j:960 + 60 * (j + 1)],
                                                     ...
                                                     k[224 + 8 * j: 224 + 8 * (j + 1)], 1, round, ancilla[160 + 18 * j: 160 + 18 * (j+1)])
    else:
        for j in range(4):  # 22 68 18
            k[96 + 8 * j: 96 + 8 * (j + 1)] = Sbox_two(eng, new_k0[8 * j:8 * (j + 1)], q2[960 + 60 * j:960 + 60 * (j + 1)], q1[1168 + 73 * j:1168 + 73 * (j + 1)],
                                                   k[96 + 8 * j: 96 + 8 * (j + 1)], 1, round, ancilla[160 + 18 * j: 160 + 18 * (j+1)])
...
def SBox_bp12_all(eng, x0, x1, x2, x3, q, s, round, ancilla):
    for i in range(4):
        ...
        x1[8 * i:8 * (i + 1)] = Sbox(eng, x1[8 * i:8 * (i + 1)], q[73 * (i + 4):73 * (i + 5)],
                                     s[8 * (i + 4):8 * (i + 5)], 0, round, ancilla[10 * (i + 4): 10 * (i + 5)])
        x2[8 * i:8 * (i + 1)] = Sbox(eng, x2[8 * i:8 * (i + 1)], q[73 * (i + 8):73 * (i + 9)],
                                     s[8 * (i + 8):8 * (i + 9)], 0, round, ancilla[10 * (i + 8): 10 * (i + 9)])
        x3[8 * i:8 * (i + 1)] = Sbox(eng, x3[8 * i:8 * (i + 1)], q[73 * (i + 12):73 * (i + 13)],
                                     s[8 * (i + 12):8 * (i + 13)], 0, round, ancilla[10 * (i + 12): 10 * (i + 13)])

def SBox_bp12_all_two(eng, x0, x1, x2, x3, q2, q1, s, round, ancilla):
    for i in range(4):
        x0[8 * i:8 * (i + 1)] = Sbox_two(eng, x0[8 * i:8 * (i + 1)], q2[60 * i:60 * (i + 1)], q1[73 * i:73 * (i + 1)],
                                         s[8 * i:8 * (i + 1)], 0, round,
                                         ancilla[10 * i: 10 * (i + 1)])
        x1[8 * i:8 * (i + 1)] = Sbox_two(eng, x1[8 * i:8 * (i + 1)], q2[60 * (i + 4):60 * (i + 5)],
                                         q1[73 * (i + 4):73 * (i + 5)],
                                         s[8 * (i + 4):8 * (i + 5)], 0, round, ancilla[10 * (i + 4): 10 * (i + 5)])
        x2[8 * i:8 * (i + 1)] = Sbox_two(eng, x2[8 * i:8 * (i + 1)], q2[60 * (i + 8):60 * (i + 9)],
                                         q1[73 * (i + 8):73 * (i + 9)],
                                         s[8 * (i + 8):8 * (i + 9)], 0, round, ancilla[10 * (i + 8): 10 * (i + 9)])
        x3[8 * i:8 * (i + 1)] = Sbox_two(eng, x3[8 * i:8 * (i + 1)], q2[60 * (i + 12):60 * (i + 13)],
                                         q1[73 * (i + 12):73 * (i + 13)],
                                         s[8 * (i + 12):8 * (i + 13)], 0, round, ancilla[10 * (i + 12): 10 * (i + 13)])
...
def Uncompute_sbox_key(eng, u, q, resource_check):
    with Dagger(eng):
        ...
        AND_gate_dag(eng, q[42], q[37], q[0])
        AND_gate_dag(eng, q[45], q[39], q[1])
        AND_gate_dag(eng, u[4], u[0], q[2])
        AND_gate_dag(eng, u[7], u[3], q[3])
        AND_gate_dag(eng, q[38], q[40], q[4])
        AND_gate_dag(eng, q[44], q[43], q[5])
        AND_gate_dag(eng, q[34], u[6], q[6])
        AND_gate_dag(eng, q[36], u[5], q[7])
        AND_gate_dag(eng, q[35], q[41], q[8])
        ...
        AND_gate_dag(eng, q[53], q[1], q[9])
        AND_gate_dag(eng, q[52], q[5], q[10])
        AND_gate_dag(eng, q[0], q[51], q[11])
        ...
        AND_gate_dag(eng, q[57], q[56], q[12])
        AND_gate_dag(eng, q[55], q[54], q[13])
        AND_gate_dag(eng, q[51], q[10], q[14])
        AND_gate_dag(eng, q[52], q[11], q[15])
        ...
        AND_gate_dag(eng, q[49], q[37], q[16])
        AND_gate_dag(eng, q[15], q[39], q[17])
        AND_gate_dag(eng, q[5], u[0], q[18])
        AND_gate_dag(eng, q[48], u[3], q[19])
        AND_gate_dag(eng, q[14], q[40], q[20])
        AND_gate_dag(eng, q[0], q[43], q[21])
        AND_gate_dag(eng, q[47], u[6], q[22])
        AND_gate_dag(eng, q[50], u[5], q[23])
        AND_gate_dag(eng, q[46], q[41], q[24])
        AND_gate_dag(eng, q[51], q[42], q[25])
        AND_gate_dag(eng, q[52], q[45], q[26])
        AND_gate_dag(eng, q[53], u[4], q[27])
        AND_gate_dag(eng, q[54], u[7], q[28])
        AND_gate_dag(eng, q[55], q[38], q[29])
        AND_gate_dag(eng, q[56], q[44], q[30])
        AND_gate_dag(eng, q[57], q[34], q[31])
        AND_gate_dag(eng, q[58], q[36], q[32])
        AND_gate_dag(eng, q[59], q[35], q[33])
...
def Uncompute_sbox_key_two(eng, u, q, q2, resource_check):
    with Dagger(eng):
        ...
        CNOT | (
            q[0], q[1])  ##### q [16~33], #### q[12~15], q[46~50], q2[13] #### q[9~11], q[54~57] ##### q[0~8], q[51~53]
        CNOT | (q[34], u[5])
        CNOT | (q[35], q2[33])
        CNOT | (q[41], q2[33])
        CNOT | (q[3], q2[31])
        ...
        AND_gate_dag(eng, q2[31], q[1], q2[30])
        AND_gate_dag(eng, q2[32], q[5], q2[29])
        AND_gate_dag(eng, q[0], q2[33], q2[28])
        ...
        AND_gate_dag(eng, q2[24], q2[25], q2[23])
        AND_gate_dag(eng, q2[26], q2[27], q2[22])
        AND_gate_dag(eng, q2[33], q2[29], q2[21])
        AND_gate_dag(eng, q2[32], q2[28], q2[20])
        ...
        AND_gate_dag(eng, q2[16], q[37], q2[14])
        AND_gate_dag(eng, q2[20], q[39], q2[15])
        AND_gate_dag(eng, q[5], u[0], q2[46])
        AND_gate_dag(eng, q2[17], u[3], q2[47])
        AND_gate_dag(eng, q2[21], q[40], q2[48])
        AND_gate_dag(eng, q[0], q[43], q2[49])
        AND_gate_dag(eng, q2[18], u[6], q2[50])
        AND_gate_dag(eng, q2[12], u[5], q2[58])
        AND_gate_dag(eng, q2[19], q[41], q2[9])
        AND_gate_dag(eng, q2[33], q[42], q2[10])
        AND_gate_dag(eng, q2[32], q[45], q2[11])
        AND_gate_dag(eng, q2[31], u[4], q2[54])
        AND_gate_dag(eng, q2[27], u[7], q2[55])
        AND_gate_dag(eng, q2[26], q[38], q2[56])
        AND_gate_dag(eng, q2[25], q[44], q2[57])
        AND_gate_dag(eng, q2[24], q[34], q2[51])
        AND_gate_dag(eng, q2[13], q[36], q2[52])
        AND_gate_dag(eng, q[59], q[35], q2[53])
...
def Sbox(eng, u, q, s, flag, round, ancilla):
    ...
    AND_gate(eng, q[42], q[37], q[0], ancilla[0])
    AND_gate(eng, q[45], q[39], q[1], ancilla[1])
    AND_gate(eng, u[4], u[0], q[2], ancilla[2])
    AND_gate(eng, u[7], u[3], q[3], ancilla[3])
    AND_gate(eng, q[38], q[40], q[4], ancilla[4])
    AND_gate(eng, q[44], q[43], q[5], ancilla[5])
    AND_gate(eng, q[34], u[6], q[6], ancilla[6])
    AND_gate(eng, q[36], u[5], q[7], ancilla[7])
    AND_gate(eng, q[35], q[41], q[8], ancilla[8])
    ...
    AND_gate(eng, q[53], q[1], q[9], ancilla[0])
    AND_gate(eng, q[52], q[5], q[10], ancilla[1])
    AND_gate(eng, q[0], q[51], q[11], ancilla[2])
    ...
    AND_gate(eng, q[57], q[56], q[12], ancilla[0])
    AND_gate(eng, q[55], q[54], q[13], ancilla[1])
    AND_gate(eng, q[51], q[10], q[14], ancilla[2])
    AND_gate(eng, q[52], q[11], q[15], ancilla[3])
    ...
    if(flag == 1):
        AND_gate(eng, q[49], q[37], q[16], ancilla[10])
        AND_gate(eng, q[15], q[39], q[17], ancilla[11])
        AND_gate(eng, q[5], u[0], q[18], ancilla[12])
        AND_gate(eng, q[48], u[3], q[19], ancilla[13])
        AND_gate(eng, q[14], q[40], q[20], ancilla[14])
        AND_gate(eng, q[0], q[43], q[21], ancilla[15])
        AND_gate(eng, q[47], u[6], q[22], ancilla[16])
        AND_gate(eng, q[50], u[5], q[23], ancilla[17])
    else:
        AND_gate(eng, q[49], q[37], q[16], s[0])
        AND_gate(eng, q[15], q[39], q[17], s[1])
        AND_gate(eng, q[5], u[0], q[18], s[2])
        AND_gate(eng, q[48], u[3], q[19], s[3])
        AND_gate(eng, q[14], q[40], q[20], s[4])
        AND_gate(eng, q[0], q[43], q[21], s[5])
        AND_gate(eng, q[47], u[6], q[22], s[6])
        AND_gate(eng, q[50], u[5], q[23], s[7])

    AND_gate(eng, q[46], q[41], q[24], ancilla[0])
    AND_gate(eng, q[51], q[42], q[25], ancilla[1])
    AND_gate(eng, q[52], q[45], q[26], ancilla[2])
    AND_gate(eng, q[53], u[4], q[27], ancilla[3])
    AND_gate(eng, q[54], u[7], q[28], ancilla[4])
    AND_gate(eng, q[55], q[38], q[29], ancilla[5])
    AND_gate(eng, q[56], q[44], q[30], ancilla[6])
    AND_gate(eng, q[57], q[34], q[31], ancilla[7])
    AND_gate(eng, q[58], q[36], q[32], ancilla[8])
    AND_gate(eng, q[59], q[35], q[33], ancilla[9])
...
def Sbox_two(eng, u, q, q2, s, flag, round, ancilla):
    ...
    AND_gate(eng, q2[31], q[1], q2[30], ancilla[0])
    AND_gate(eng, q2[32], q[5], q2[29], ancilla[1])
    AND_gate(eng, q[0], q2[33], q2[28], ancilla[2])
    ...
    AND_gate(eng, q2[24], q2[25], q2[23], ancilla[0])
    AND_gate(eng, q2[26], q2[27], q2[22], ancilla[1])
    AND_gate(eng, q2[33], q2[29], q2[21], ancilla[2])
    AND_gate(eng, q2[32], q2[28], q2[20], ancilla[3])
    ...
    if(flag == 1):
        AND_gate(eng, q2[16], q[37], q2[14], ancilla[10])
        AND_gate(eng, q2[20], q[39], q2[15], ancilla[11])
        AND_gate(eng, q[5], u[0], q2[46], ancilla[12])
        AND_gate(eng, q2[17], u[3], q2[47], ancilla[13])
        AND_gate(eng, q2[21], q[40], q2[48], ancilla[14])
        AND_gate(eng, q[0], q[43], q2[49], ancilla[15])
        AND_gate(eng, q2[18], u[6], q2[50], ancilla[16])
        AND_gate(eng, q2[12], u[5], q2[58], ancilla[17])
    else:
        AND_gate(eng, q2[16], q[37], q2[14], s[0])
        AND_gate(eng, q2[20], q[39], q2[15], s[1])
        AND_gate(eng, q[5], u[0], q2[46], s[2])
        AND_gate(eng, q2[17], u[3], q2[47], s[3])
        AND_gate(eng, q2[21], q[40], q2[48], s[4])
        AND_gate(eng, q[0], q[43], q2[49], s[5])
        AND_gate(eng, q2[18], u[6], q2[50], s[6])
        AND_gate(eng, q2[12], u[5], q2[58], s[7])

    AND_gate(eng, q2[19], q[41], q2[9], ancilla[0])
    AND_gate(eng, q2[33], q[42], q2[10], ancilla[1])
    AND_gate(eng, q2[32], q[45], q2[11], ancilla[2])
    AND_gate(eng, q2[31], u[4], q2[54], ancilla[3])
    AND_gate(eng, q2[27], u[7], q2[55], ancilla[4])
    AND_gate(eng, q2[26], q[38], q2[56], ancilla[5])
    AND_gate(eng, q2[25], q[44], q2[57], ancilla[6])
    AND_gate(eng, q2[24], q[34], q2[51], ancilla[7])
    AND_gate(eng, q2[13], q[36], q2[52], ancilla[8])
    AND_gate(eng, q[59], q[35], q2[53], ancilla[9])
